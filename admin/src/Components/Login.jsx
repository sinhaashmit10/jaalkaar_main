  ...
  return (
    <div className='min-h-screen flex items-center justify-center'>
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            <h1 className='text-2xl font-bold mb-4 text-[#800020]'>Admin Panel</h1>
            <form onSubmit={onSubmitHandler}>
                ...
                <button className='mt-2 w-full py-2 px-4 rounded-md bg-[#800020] text-[#D4AF37]' type="submit">Login</button>
            </form>
        </div>
    </div>
  )
